...
class PublicationModelTest(TestCase):
    ...
    def test_labels(self):
        ...
        field_label_views_count = self.publication._meta.get_field('views_count').verbose_name
...
class PublicationViewTest(TestCase):
    ...
    def test_list_view(self):
        ...
        self.assertTrue(len(response.context['publication_list']) == NUMBER_OF_PUBLICATION_ON_PAGE)
