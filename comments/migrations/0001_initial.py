    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('publication', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='comments', to='publications.publication', verbose_name='Публикация')),
            ],
            options={
